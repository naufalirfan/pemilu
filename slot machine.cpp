...
int main(){
    ...
    if (GetAsyncKeyState(VK_SPACE) & 0x8000){tanda=1;}
    if (tanda==1){jeda+=jeda/9;}
    if (jeda>250){
        goto random2;
    } else {
        Sleep(jeda);goto random1;}
